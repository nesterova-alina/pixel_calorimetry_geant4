...
//  3
  ...
  //Физический объем детектора
  new G4PVPlacement(0,                       //no rotation, так же без вращения
                    G4ThreeVector(0,0,13.5*cm),         //at (0,0,0)
...
//1
   G4Box* solidTgt1 =
    new G4Box("Target1",                    //its name, имя
        0.5*tgt_sizeX, 0.5*tgt_sizeY, 0.5*2*cm); //its size, размеры
  ...
  //Физический объем
  new G4PVPlacement(0,                       //no rotation, так же без вращения
                    G4ThreeVector(0,0,8.5*cm),         //at (0,0,0)
...
//2
  ...
  //Физический объем
  new G4PVPlacement(0,                       //no rotation, так же без вращения
                    G4ThreeVector(0,0,12.25*cm),         //at (0,0,0)
...
//3
  ...
  //Физический объем
  new G4PVPlacement(0,                       //no rotation, так же без вращения
                    G4ThreeVector(0,0,15.25*cm),         //at (0,0,0)
