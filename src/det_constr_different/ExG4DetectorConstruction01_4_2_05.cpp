...
//1
   G4Box* solidTgt1 =
    new G4Box("Target1",                    //its name, имя
        0.5*tgt_sizeX, 0.5*tgt_sizeY, 0.5*4*cm); //its size, размеры
  ...
  //Физический объем
  new G4PVPlacement(0,                       //no rotation, так же без вращения
                    G4ThreeVector(0,0,9.5*cm),         //at (0,0,0)
...
//2
  ...
  //Физический объем
  new G4PVPlacement(0,                       //no rotation, так же без вращения
                    G4ThreeVector(0,0,15.0*cm),         //at (0,0,0)
...
//3
  ...
  //Физический объем
  new G4PVPlacement(0,                       //no rotation, так же без вращения
                    G4ThreeVector(0,0,18.75*cm),         //at (0,0,0)
