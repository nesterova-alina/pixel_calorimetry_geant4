...
//  3
  ...
  //Физический объем детектора
  new G4PVPlacement(0,                       //no rotation, так же без вращения
                    G4ThreeVector(0,0,13*cm),         //at (0,0,0)
...
//  4
  ...
  //Физический объем детектора
  new G4PVPlacement(0,                       //no rotation, так же без вращения
                    G4ThreeVector(0,0,16*cm),         //at (0,0,0)
...
//1
   G4Box* solidTgt1 =
    new G4Box("Target1",                    //its name, имя
        0.5*tgt_sizeX, 0.5*tgt_sizeY, 0.5*1.5*cm); //its size, размеры
  ...
  //Физический объем
  new G4PVPlacement(0,                       //no rotation, так же без вращения
                    G4ThreeVector(0,0,8.25*cm),         //at (0,0,0)
...
//2
   G4Box* solidTgt2 =
    new G4Box("Target2",                    //its name, имя
        0.5*tgt_sizeX, 0.5*tgt_sizeY, 0.5*0.5*cm); //its size, размеры
  ...
  //Физический объем
  new G4PVPlacement(0,                       //no rotation, так же без вращения
                    G4ThreeVector(0,0,11.75*cm),         //at (0,0,0)
...
//3
  ...
  //Физический объем
  new G4PVPlacement(0,                       //no rotation, так же без вращения
                    G4ThreeVector(0,0,14.75*cm),         //at (0,0,0)
 ...
 G4Box* solidTgt0_out =
  ...
  //Физический объем
  new G4PVPlacement(0,                       //no rotation, так же без вращения
                    G4ThreeVector(0,0,18*cm),         //at (0,0,0)
